...
export const ProductCard = memo(({ product, onProductClick, index }: ProductCardProps) => {
  ...
  return (
    <motion.div
      className="group bg-white h-[60vh] lg:min-h-[35vh] xl:min-h-[50vh] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 cursor-pointer border"
